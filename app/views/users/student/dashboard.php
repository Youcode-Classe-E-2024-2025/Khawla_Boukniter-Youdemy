    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-8">
            <div class="flex items-center justify-between">
                ...
                <a href="/teacher/courses/create" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
                    Créer un cours
                </a>
            </div>
                            ...
                            <div class="flex items-center">
                                <div class="flex-1 truncate">
                                    <div class="flex items-center space-x-3">
                                        <h3 class="text-sm font-medium text-gray-900 truncate"><?= htmlspecialchars($course['title']) ?></h3>
                                        <span class="flex-shrink-0 inline-block px-2 py-0.5 text-xs font-medium <?= $course['status'] === 'published' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' ?> rounded-full">
